...
export default function CreateNewBlog() {
  ...
  useEffect(() => {
    AuthAPI.get(`${process.env.NEXT_PUBLIC_BASE_URL}/user/hospital/`)
      .then(res => {
  ...
  const formattedDate =
    new Date(blog[1]?.date).toLocaleDateString('en-CA', {
      year: 'numeric',
      month: '2-digit',
      day: '2-digit'
    }) ?? 'Invalid Date'
  ...
  return (
    <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between  lg:px-16">
          <div className="flex flex-col justify-center items-start gap-3 mb-20 ">
            ...
            <div>
              ...
              <div className="text-base font-normal">{hospital?.location}</div>
          ...
          <div className="flex flex-col gap-3 items-center justify-center ">
            <div className=" flex flex-col shadow-sm rounded-2xl lg:w-[403px] w-full  bg-[#FAFAFE] p-3">
              ...
              <div className="flex flex-col p-3">
                ...
                <span className=" text-xs font-normal">{blogDetailLabel}</span>
              </div>
                ...
                <div className="flex justify-between  ">
                  <div className="flex gap-2">
                    ...
                    <div className="flex flex-col">
                      <div className="text-xs font-semibold">
                        {' '}
                        Written by {blog[1]?.publishedby}
                      </div>
                      <div className="text-xs">{formattedDate}</div>
                      <img
                        src="/img/carehorn 12.png"
                        alt="carehorn"
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="text-xs">
                      Blocked:{' '}
                      {blog?.status === '0' ? 'Blocked' : 'Not Blocked'}
                    </div>
                  </div>
                </div>
              </div>
      ...
      <form
        className="container flex flex-col justify-center items-center w-full gap-10"
