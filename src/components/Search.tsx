        ...
        <div className="w-full pt-16">
            ...
            <div className=' flex  justify-center items-center flex-col'>
                ...
                <ReactPaginate
                    ...
                    pageClassName={'bg-blue-700 text-white px-4 py-2 mr-2 rounded-md cursor-pointer '}
                    activeClassName={'bg-blue-700'}
                    previousClassName={'border border-blue-700 text-[#546DEA] px-4 py-2 mr-2 rounded-md cursor-pointer'}
                    nextClassName={'border border-blue-700 text-[#546DEA]   px-4 py-2 mr-2 rounded-md cursor-pointer'}
