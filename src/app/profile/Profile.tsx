            ...
            <div className="container flex items-center justify-center ">
                <div className="bg-slate-200 flex flex-col w-full py-5 items-center justify-center rounded-xl  ">
                    <div className="flex flex-col items-center justify-center p-8 m-5 bg-white rounded-xl">
                        ...
                        <figcaption className='text-black text-center text-xl font-semibold'>{loggedInUser?.name}</figcaption>
                        <div className='flex flex-col items-start justify-center'>
                            <div className='text-xl py-2 flex gap-2'><MdOutlineMailOutline className="mt-1.5" />Email:
                                <span className='text-xl'> {loggedInUser?.email}</span>
                            </div>
                            <div className='text-xl py-2 flex gap-2'><MdAdminPanelSettings className="mt-1.5" />Role:
                                <span className='text-xl'> {loggedInUser?.role}</span>
                            </div>
                            <div className='text-xl py-2 flex gap-2'><IoMdContact className="mt-1.5" />Contact:
                                <span className='text-xl'> {loggedInUser?.phoneNum}</span>
                            </div>
                            <div className='text-xl py-2 flex gap-2'><FaRegAddressBook className="mt-1.5" />Address:
                                <span className='text-xl'> {loggedInUser?.address}</span>
                            </div>
                            <div className='text-xl py-2 flex gap-2'><CiCalendarDate className="mt-1.5" />Date Of Birth:
                                <span className='text-xl'> {loggedInUser?.dob}</span>
                            </div>
                            <div className='text-xl py-2 flex gap-2'><FaMoneyCheckAlt className="mt-1.5" />Balance:
                                <span className='text-xl'> {loggedInUser?.balance}</span>
                            </div>
                            <div className='text-xl py-2 flex gap-2'><GoOrganization className="mt-1.5" />Organization Name:
                                <span className='text-xl'> {loggedInUser?.orgName}</span>
                            </div>
                            <div className='text-xl py-2 flex gap-2'><MdOutlineDescription className="mt-1.5" />Bio:
                                <span className='text-xl'> {loggedInUser?.bio}</span>
                            </div>
                            <div className='text-xl py-2'>Citizenship Image:
