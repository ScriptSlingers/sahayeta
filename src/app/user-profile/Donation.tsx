            ...
            <div className='w-[99%] min-h-screen '>
                ...
                <div className='m-2 p-2'>
                    ...
                    <div className=' flex items-center justify-around p-4'>
                        <div className='bg-blue-500 text-white w-fit flex flex-col items-start justify-center p-4 border-1 rounded-xl'>
                            ...
                            {data.map((val, key) => {
                                return (
                                    <tbody className="bg-white">
                                        <tr key={key}>
                                            <td className='px-4 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5 '>{val.name}</td>
                                            <td className='px-4 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5'>{val.location}</td>
                                            <td className='px-4 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5'>{val.category}</td>
                                            <td className='px-4 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5'>{val.date}</td>
                                            <td className='px-4 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5'>{val.amount}</td>
                                            <td className='px-4 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5'>{val.status}</td>
                                        </tr>
                                    </tbody>
                                )
                            })}
